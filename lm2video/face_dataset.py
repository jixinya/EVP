...
class FaceDataset(BaseDataset):
    def initialize(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, opt.phase + '_keypoints' + opt.mode)
        self.dir_B = os.path.join(opt.dataroot, opt.phase + '_img' + opt.mode)
        print(self.dir_A)
    ...
    def __getitem__(self, index):
      ...
      #  C_paths = self.C_paths[seq_idx]
       ...
       #     C_path = C_paths[start_idx + i * t_step]        
            ...
            #Ai, Li = self.get_face_image(A_path, transform_scaleA, transform_label, B_size, B_img, C_path)
